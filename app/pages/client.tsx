...
export function meta() {
  return [
    { title: "Clients — Fakturia" },
    {
      name: "description",
      content:
        "Manage client contacts, payment terms and outstanding balances.",
    },
    {
      property: "og:title",
      content: "Clients — Fakturia",
    },
    {
      property: "og:description",
      content: "Manage your client list and balances.",
    },
  ];
}
...
export default function ClientsPage() {
  ...
  const handleSubmit = form.handleSubmit((values) => {
    if (editing) {
      updateClient(
        editing.id,
        values as Partial<Client>
      );

      toast.success("Client updated");
    } else {
      addClient(
        values as Omit<Client, "id" | "createdAt">
      );
  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        description={`${toDelete?.name ?? ""} will be removed from your client list. This action cannot be undone from the interface.`}
